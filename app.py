...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .role-btn.selected { border-color: #3B82F6; background-color: #EFF6FF; color: #3B82F6; }
...
<body>
    <div id="app">
        ...
        <div id="mainApp" style="display: none;">
            ...
            <nav class="tabs">
                <button class="tab active" onclick="switchTab('pendientes')">Pendientes (<span id="pendientesCount">0</span>)</button>
                <button class="tab" onclick="switchTab('en-progreso')">En Progreso (<span id="progresoCount">0</span>)</button>
                <button class="tab" onclick="switchTab('completadas')">Completadas (<span id="completadasCount">0</span>)</button>
                ...
                <form onsubmit="createTask(event)">
                    ...
                    <div class="form-group">
                        ...
                        <select id="taskTurbine" class="form-select">
                            ...
                            {% for i in range(1, 31) %}
                            <option value="WTG {{ '%02d'|format(i) }}">WTG {{ '%02d'|format(i) }}</option>
                            {% endfor %}
                        </select>
                    </div>
                    <div class="form-group">
...
if __name__ == '__main__':
    ...
    print("📱 Para acceso móvil, usa la IP de tu computadora")
